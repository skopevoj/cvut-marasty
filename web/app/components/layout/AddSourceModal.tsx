...
export function AddSourceModal({ isOpen, onClose }: AddSourceModalProps) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Přidat zdroj otázek" maxWidth="max-w-xl">
            <div className="space-y-6">
                <div className="glass-card-themed p-4 bg-blue-500/5 border-blue-500/10 flex gap-3 items-start">
                    <Info size={18} className="text-blue-500 shrink-0 mt-0.5" />
                    <p className="text-xs text-[var(--fg-muted)] leading-relaxed">
                        Zdrojem musí být JSON soubor obsahující seznam otázek ve správném formátu.
                        Můžete použít URL adresu na veřejný soubor nebo nahrát vlastní ze zařízení.
                    </p>
                </div>
                ...
                <div className="grid gap-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <label className="glass-button w-full flex items-center justify-center gap-3 cursor-pointer py-4 hover:bg-white/5 transition-colors group">
                            <Upload size={18} className="text-[var(--fg-muted)] group-hover:text-[var(--fg-primary)] transition-colors" />
